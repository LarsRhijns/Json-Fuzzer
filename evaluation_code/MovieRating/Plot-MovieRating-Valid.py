...
for line in open('../../output/MovieRating-10runs-valid/1623502028395/datapoints/points.txt', 'r'):
    values = [float(s) for s in line.split(',')]
    x10.append(values[1])
    y10.append(values[0])

for line in open('../../output/MovieRating-10runs-valid/1623502045697/datapoints/points.txt', 'r'):
    values = [float(s) for s in line.split(',')]
    x9.append(values[1])
    y9.append(values[0])

for line in open('../../output/MovieRating-10runs-valid/1623502056307/datapoints/points.txt', 'r'):
    values = [float(s) for s in line.split(',')]
    x8.append(values[1])
    y8.append(values[0])

for line in open('../../output/MovieRating-10runs-valid/1623502067699/datapoints/points.txt', 'r'):
    values = [float(s) for s in line.split(',')]
    x7.append(values[1])
    y7.append(values[0])

for line in open('../../output/MovieRating-10runs-valid/1623502082477/datapoints/points.txt', 'r'):
    values = [float(s) for s in line.split(',')]
    x6.append(values[1])
    y6.append(values[0])

for line in open('../../output/MovieRating-10runs-valid/1623502096870/datapoints/points.txt', 'r'):
    values = [float(s) for s in line.split(',')]
    x5.append(values[1])
    y5.append(values[0])

for line in open('../../output/MovieRating-10runs-valid/1623502107803/datapoints/points.txt', 'r'):
    values = [float(s) for s in line.split(',')]
    x4.append(values[1])
    y4.append(values[0])

for line in open('../../output/MovieRating-10runs-valid/1623502121962/datapoints/points.txt', 'r'):
    values = [float(s) for s in line.split(',')]
    x3.append(values[1])
    y3.append(values[0])

for line in open('../../output/MovieRating-10runs-valid/1623502132448/datapoints/points.txt', 'r'):
    values = [float(s) for s in line.split(',')]
    x2.append(values[1])
    y2.append(values[0])

for line in open('../../output/MovieRating-10runs-valid/1623502143847/datapoints/points.txt', 'r'):
    values = [float(s) for s in line.split(',')]
    x1.append(values[1])
    y1.append(values[0])
