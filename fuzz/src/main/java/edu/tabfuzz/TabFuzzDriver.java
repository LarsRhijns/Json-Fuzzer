...
public class TabFuzzDriver {
    public static void main(String[] args) {
        ...
        String fileConf = "";
        if (seed) {
            fileConf = "fuzz/src/main/java/edu/tabfuzz/dataset/configuration.csv";
        } else {
            ...
            fileConf = "fuzz/src/main/java/edu/tabfuzz/dataset/randomConfiguration.csv";
            try {
        ...
        try {
            ...
            TabFuzzGuidance guidance = new TabFuzzGuidance("Test1", fileConf, 5, duration, System.err);
