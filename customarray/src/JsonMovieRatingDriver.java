...
@RunWith(JQF.class)
public class JsonMovieRatingDriver {

    @Fuzz
    public void testJsonMovieRating(String fileName) throws IOException {
        if (PRINT_METHOD_NAMES) {
            System.out.println("[METHOD] JsonMovieRatingDriver::testJsonMovieRating");
        }
